package com.velamdir.AssigmentSubmissionAndReviewApp.util;
...
public class JwtUtil implements Serializable {    
    private static final long serialVersionUID = 6084652990962254982L;
    ...
    // Get a single claim from the token
